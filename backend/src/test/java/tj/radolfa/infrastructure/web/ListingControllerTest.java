...
// ListingController controller = new ListingController(fakeUseCase, new
// FakeUpdateListingUseCase());
...
// @Test
// @DisplayName("GET /api/v1/listings/{slug} returns detail with SKUs and
// siblings")
...
// @Override
// public PageResult<ListingVariantDto> search(String query, int page, int
// limit) {
// return new PageResult<>(List.of(GRID_ITEM), 1, page, false);
// }
