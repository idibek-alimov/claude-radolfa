...
// import
// tj.radolfa.application.ports.in.SyncProductHierarchyUseCase.HierarchySyncCommand;
// import
// tj.radolfa.application.ports.in.SyncProductHierarchyUseCase.HierarchySyncCommand.VariantCommand;
// import
// tj.radolfa.application.ports.in.SyncProductHierarchyUseCase.HierarchySyncCommand.SkuCommand;
...
// @Test
// @DisplayName("Creates new ProductBase, ListingVariant, and Sku when none
// exist")
...
// @Test
// @DisplayName("Upsert: updates existing ProductBase name without creating
// duplicates")
...
// assertEquals(1, fakeSave.baseSaveCount, "Should save once, not create a new
// one");
// }
...
// @Override
// public Optional<ListingVariant> findByProductBaseIdAndColorKey(Long baseId,
// String colorKey) {
...
// return new ProductBase(idGen.getAndIncrement(), base.getErpTemplateCode(),
// base.getName());
// }
