...
--
-- DEV ONLY — 30 product bases × 3 colours × 3 sizes = 270 SKUs.
-- This file lives in db/migration/dev/ and is only picked up when
-- spring.flyway.locations includes classpath:db/migration/dev
