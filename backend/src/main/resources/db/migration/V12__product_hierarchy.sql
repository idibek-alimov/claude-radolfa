-- ================================================================
-- V12__product_hierarchy.sql
--
-- Introduces the 3-tier product hierarchy:
--   ProductBase (Template) → ListingVariant (Colour) → Sku (Size)
--
-- The existing 'products' table is left intact for now;
-- data migration is a separate step once reads are migrated.
-- ================================================================
