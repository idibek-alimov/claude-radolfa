...
INSERT INTO order_statuses (name) VALUES ('PENDING'), ('PAID'), ('AWAITING_COD'), ('PICKED'), ('CLAIMED'), ('SHIPPED'), ('OUT_FOR_DELIVERY'), ('DELIVERY_ATTEMPTED'), ('RECALL_REQUESTED'), ('READY_FOR_PICKUP'), ('RETURN_INITIATED'), ('RETURNED_TO_WAREHOUSE'), ('DELIVERED'), ('CANCELLED'), ('REFUNDED');
