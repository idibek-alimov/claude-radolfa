...
public interface UpdateCategoryUseCase {
     ...
     * @param traitIds IDs of review traits to link; null means leave existing links untouched
     */
    void execute(Long id, String name, Long parentId, java.util.Set<Long> traitIds);
}
