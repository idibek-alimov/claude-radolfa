...
import { useConfirmDelivery } from "@/features/courier/api";
...
function classifyError(err: unknown): string {
  ...
  return getErrorMessage(err, "Failed to confirm delivery");
}

export function DeliveryConfirmModal({ open, onClose, orderId }: Props) {
  ...
  function handleConfirm() {
    ...
    confirm.mutate(
      { orderId, code },
      {
        onSuccess: () => { toast.success("Delivery confirmed!"); onClose(); },
