...
import { useCheckout, CheckoutStepper, DeliveryStep } from "@/features/checkout";
  ...
  return (
    <>
      ...
      <div className="max-w-2xl mx-auto px-4 py-10 space-y-6">
        ...
        {/* Review — interim placeholder; real ReviewStep ships in Phase 10 */}
        {wizard.step === "review" && (
          <div className="rounded-xl border bg-card shadow-sm p-5 space-y-4">
            <h2 className="font-semibold">{t("steps.review")}</h2>
            ...
            <div className="flex items-center justify-between">
              ...
              <Button onClick={wizard.next}>{t("steps.payment")}</Button>
            </div>
          </div>
        )}
